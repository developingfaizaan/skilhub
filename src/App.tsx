  ...
  const renderContent = () => {
    ...
    return (
      <div className="flex flex-col gap-12">
        {/* Unique Hero Section */}
        {currentPage === 'home' && (
          <div className="page-enter relative py-12 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center gap-8">
              <div className="flex items-center gap-3 bg-accent-primary/5 border border-accent-primary/20 px-4 py-1.5 rounded-full">
                <Zap size={14} className="text-accent-primary" fill="currentColor" />
                <span className="text-[10px] font-bold uppercase tracking-widest text-accent-primary">New: Research Agent v2.4</span>
              </div>
              ...
              <div className="flex flex-col gap-4 max-w-4xl">
                ...
                <p className="text-text-muted text-lg max-w-2xl mx-auto leading-relaxed">
                  A high-performance registry for procedural agent skills. <br />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-8 w-full max-w-3xl">
                {[
          ...
          <div className="flex flex-col gap-8 max-w-7xl mx-auto w-full">
            <div className="flex items-center justify-between border-b border-border-subtle pb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded bg-accent-primary/10 flex items-center justify-center text-accent-primary">
                  <Compass size={20} />
                </div>
